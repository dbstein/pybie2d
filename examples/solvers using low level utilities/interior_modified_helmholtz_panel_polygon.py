...
# boundary
boundary = PPB([0,1,1,0], [0,0,1,1], [h_max]*4, [True]*4, dyadic_levels=16, dyadic_base=3)
# solution
...
u = Modified_Helmholtz_Layer_Apply(boundary, gridp, k=helmholtz_k, dipstr=tau)
u = gridp.reshape(u)
err_plot(u)
...
ftau = IMAT.dot(tau)
u = Modified_Helmholtz_Layer_Apply(fbdy, gridp, k=helmholtz_k, dipstr=ftau)
u = gridp.reshape(u)
err_plot(u)
